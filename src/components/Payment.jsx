...
const Payment = () => {
  ...
  return (
    <div className="bg-white">
      <div>
        <h1 className="text-center p-2.5 font-normal bg-[#eaeded] border-b border-gray-300">
          Checkout (
          <Link className="decoration-none" to="/checkout">
            {basket?.length} items
          </Link>
          )
        </h1>
        <div className="flex p-5 my-0 mx-5 border-b border-gray-300">
          ...
          <div className="flex-[0.8]">
            <form className="max-w-100" onSubmit={handleSubmit}>
              ...
              <div className="payment_priceContainer">
                ...
                <button
                  className=" w-full h-7.5 bg-[#f0c14b] rounded-[20px] border border-t-[#a88734] border-l-[#9c7e31]
                        border-b-[#846a29] border-r-[#9c7e31] font-extrabold mt-2.5 text-[#111] cursor-pointer"
                  disabled={
